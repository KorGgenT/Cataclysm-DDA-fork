...
long learn_spell_actor::use( player &p, item &, bool, const tripoint & ) const
{
    ...
    if( knows_spell ) {
        ...
        const int study_time = uilist( _( "Spend how long studying?" ), {
                                        { 300, true, -1, _( "30 minutes" ) },
                                        { 600, true, -1, _( "1 hour" ) },
                                        { 1200, true, -1, _( "2 hours" ) },
                                        { 2400, true, -1, _( "4 hours" ) },
                                        { 4800, true, -1, _( "8 hours" ) },
                                        { 101, true, -1, _( "Until you gain a spell level" ) }
        } );
        if( study_time <= 0 ) {
            return 0;
        }
    ...
    if( study_spell.moves_total == 101 ) {
